...
const PhotoGallery: React.FC = () => {
  ...
  const photos = [
    ...
    },
    {
      ...
      photographer: 'Food Stories Mumbai',
      date: '2024-01-12',
      views: 2100,
      likes: 156,
      type: 'photo',
      featured: true,
      description: 'Chef Meera\'s signature street food thali featuring Mumbai\'s iconic flavors'
    },
    {
      id: 3,
      ...
      photographer: 'Mumbai Culture Co.',
      date: '2024-01-10',
      views: 890,
      likes: 67,
      type: 'photo',
